...
public class OpenClose {
    ...
    public void ejecutarCalculadoraImpuestos() {
        ...
        Producto producto1 = new Producto(1540);
        Producto producto2 = new Producto(450.12);
        Producto producto3 = new Producto(951.14);
        Producto producto4 = new Producto(9845.8);
        producto1.setTipo("Iva");
        producto2.setTipo("Importado");
        producto3.setTipo("Nacional");
        producto4.setTipo("Iva");

        Impuesto impuesto = new ImpuestoIva();
        ...
        System.out.println("\nEl monto a pagar por concepto de impuestos para los productos ingresados es de: " + calculadoraImpuestos.calcularImpuestos(productos) + "$");
        CalculadoraImpuestosAntiPatron calculadoraImpuestosAntiPatron = new CalculadoraImpuestosAntiPatron();
        calculadoraImpuestosAntiPatron.calcularImpuestosAntiPatron(productos);
    }
    ...
    class ImpuestoIva extends Impuesto {
        @Override
        double calcular(Producto producto) {
