...
public class OpenClose {
    ...
    public void ejecutar() {
        ...
        productos.add(new Producto(100.000));
        productos.add(new Producto(200.000));
        productos.add(new Producto(500.000));
        ...
        System.out.println("Total Impuesto a pagar : $ " + totalImpuesto);
    ...
    class ImpuestoDeAzar extends Impuesto {
