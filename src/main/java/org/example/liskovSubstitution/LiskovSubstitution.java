...
public class LiskovSubstitution {
    ...
    public void ejecutar() {
        ...
        alimentos.add(new Carne("Res"));
        alimentos.add(new Vegetales("Espinaca"));
...
class EmpleadoEjecutivo extends Empleado {
    ...
    public void tomarDecision() {
        System.out.println("Decision empleado ejecutivo");
    }
}
...
class EmpleadoOperativo extends Empleado {
    ...
    public void realizarOperacion() {
        //...
        System.out.println("Empleado realizando operación");
    }
}
...
class EmpleadoTemporal extends Empleado {
    ...
    public void realizarTareaTemporal() {
        System.out.println("Enpleado realizando tarea temporal");
    }
}

/**
 * Ejemplo liskovSustitution en el contexto de restaurante
 */

abstract class Alimento {
    abstract void prepararComida();
}

class Vegetales extends Alimento {
    private String nombre;

    public Vegetales(String nombre) {
        this.nombre = nombre;
    }

    @Override
    public void prepararComida() {
        System.out.println("Preparando" + nombre + "vegetales");
